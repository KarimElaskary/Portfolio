    ...
    <section className='py-[50px] xl:py-[200px] mx-[10%] md:mx-[120px]'>
      <div className='flex flex-col items-center justify-center gap-6 h-full w-full'>
        ...
        <a
          ...
          className='bg-gradient-to-r from-[#50CAE4] to-[#9B5CFF] text-white font-bold py-3 px-6 rounded-full shadow-lg transform transition-all duration-500 ease-in-out hover:scale-110 hover:brightness-110 hover:animate-pulse active:animate-bounce">
  Keep holding'
        >
          Download My CV
        </a>
